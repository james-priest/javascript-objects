...
**View code:** ([e-prototype-function.js](src/e-prototype-function.js))
...
**View code:** ([h-namespace-singleton.js](src/h-namespace-singleton.js))
...
**View code:** ([j-base-class.js](src/j-base-class.js))
